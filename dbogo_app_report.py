...
#create default arguments for our DAG
default_args = {
    'owner': '', #insert owner
...
schedule_interval = '0 11 * * *' # creating schedule

@dag(default_args=default_args, schedule_interval=schedule_interval, catchup=False) # passing arguments for our dag
def dbogoslovtsev_app_report_dag():
...
dbogoslovtsev_app_report_dag = dbogoslovtsev_app_report_dag()